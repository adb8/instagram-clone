...
export const smallHomeInstagramLogo = (color) => (
  <svg
...
export const notificationsIcon = (color) => (
  <svg
...
export const threadsIcon = (color) => (
  <svg
    aria-label=""
    class="x1lliihq x1n2onr6 x5n08af"
    fill={color}
...
export const largeHomeInstagramIcon = (color) => (
  <svg
    aria-label="Instagram"
    class="x1lliihq x1n2onr6 x5n08af"
    fill={color}
...
export const loginInstagramIcon = (color) => (
  <i
...
export const getFromGooglePlayIcon = (size) => (
  <img
...
export const getFromMicrosoft = (size) => (
  <img
...
export const phoneImages = (size) => <img alt="Phone images" width={size} src={phone} />;

export const photosVideosIcon = (color) => (
  <svg
...
export const backIcon = (color, onClick) => (
  <svg
    onClick={onClick}
    aria-label="Back"
    class="x1lliihq x1n2onr6 x5n08af"
...
export const sharedIcon = () => (
  <img
    ...
    src="https://static.cdninstagram.com/rsrc.php/v3/yD/r/ywSe_I8p9lm.gif"></img>
);

export const _3dotsIcon = (color) => (
  <svg
...
export const filledHeartIcon = (color) => (
  <svg
    aria-label="Unlike"
